...
useSeoMeta({
  ...
  ogImage: "/diet_561611.png",
  ogUrl: `http:localhost:3000`,
  twitterTitle: "Nuxtcipes",
  twitterDescription: "Recipes for you to cook!",
  twitterImage: "/diet_561611.png",
  twitterCard: "summary",
});
        ...
        <section class="bg-[#f1f1f1]">
            <div class="container flex flex-col lg:flex-row items-center py-20 gap-10">
                <div class="flex-1 order-2 lg:order-1 text-center lg:text-left">
                    ...
                    <button
                        class="px-4 py-2 text-white self-start bg-dodgerroll-gold rounden-md text-lg cursor-pointer">
                        Browse Recipes
                    </button>
                </div>
                <div class="flex-1 order-1 lg:order-2">
                    <NuxtImg sizes="xs:100vw sm:667px" format="webp" src="/diet_561611.png" alt="" />
                </div>
            </div>
        </section>
